...
if(show === true){
return(
<div className="w-full bg-slate-500 bg-opacity-60 flex justify-center fixed top-0 h-full z-50">
    <div className="w-72 h-fit bg-white rounded-md mt-16 flex flex-col items-center">
        <div className="w-64 h-9 text-left font-bold text-lg border-b-2 border-b-gray-400">{head}</div>
        <div className="w-64 h-fit min-h-28 border-b-2 border-b-gray-400">{body}</div>
        <div className="w-64 h-12 flex justify-end">
